...
export default function register(pi: any): void {
  pi.registerTool({
    name: "omp_read",
    label: "OMP Read",
    description: "Read a file and return its oh-my-pi hashline snapshot tag and content.",
  ...
  pi.registerTool({
    name: "omp_patch",
    label: "OMP Patch",
    description: "Apply an oh-my-pi hashline patch atomically after snapshot validation.",
