...
| `E_SUSPICIOUS_TEXT` | `src/hashline/served-guard.ts:258-264` | Omit copied anchors from `replace_with` and retry with the same anchors, or use `mode: "literal"` | `README.md:187` | `CONTEXT.md:141-142` | consistent |
